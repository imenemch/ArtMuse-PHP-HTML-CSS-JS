...
<html>
<head>
  <title>Catégorie Peinture</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <h1>Catégorie Peinture</h1>

  <?php
    // Inclusion du fichier de connexion à la base de données
    include 'connect.php';

    // Requête pour récupérer les œuvres de la catégorie "peinture"
    $query = "SELECT * FROM oeuvre WHERE categorie = 'Peinture'";
    ...
    if (mysqli_num_rows($result) > 0) {
      ...
      echo 'Aucune œuvre trouvée dans la catégorie "Peinture".';
    }
